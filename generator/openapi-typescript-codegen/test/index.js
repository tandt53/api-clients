...
const main = async () => {
    ...
    // await generate('./test/spec/openapi.json', './test/generated/petstore/');
    await generate('/Users/tando/projects/XEN/banking/packages/app/src/docs/openapi.yaml', './test/generated/banking/');
