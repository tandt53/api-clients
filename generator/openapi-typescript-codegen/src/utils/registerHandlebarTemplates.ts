...
import templateCoreBinaryType from '../templates/core/BinaryType.hbs';
import templateCoreApiResult from '../templates/core/ApiResult.hbs';
import axiosRequest from '../templates/core/axios/axios.client.hbs';
...
import codeceptjsRequest from '../templates/core/codeceptjs/codeceptjs.client.hbs';
import codeceptjsGetHeaders from '../templates/core/codeceptjs/getHeaders.hbs';
import codeceptjsGetRequestBody from '../templates/core/codeceptjs/getRequestBody.hbs';
import codeceptjsGetResponseBody from '../templates/core/codeceptjs/getResponseBody.hbs';
import codeceptjsGetResponseHeader from '../templates/core/codeceptjs/getResponseHeader.hbs';
import codeceptjsSendRequest from '../templates/core/codeceptjs/sendRequest.hbs';
...
import k6GetHeaders from '../templates/core/k6/getHeaders.hbs';
import k6GetRequestBody from '../templates/core/k6/getRequestBody.hbs';
import k6GetResponseBody from '../templates/core/k6/getResponseBody.hbs';
import k6GetResponseHeader from '../templates/core/k6/getResponseHeader.hbs';
import k6Request from '../templates/core/k6/k6.client.hbs';
import k6SendRequest from '../templates/core/k6/sendRequest.hbs';
...
export interface Templates {
    ...
    core: {
        ...
        binaryType: Handlebars.TemplateDelegate;
...
export const registerHandlebarTemplates = (root: {
    ...
    const templates: Templates = {
        ...
        core: {
            ...
            binaryType: Handlebars.template(templateCoreBinaryType),
    ...
    // Specific files for the axios client implementation
    Handlebars.registerPartial('codeceptjs/getHeaders', Handlebars.template(codeceptjsGetHeaders));
    Handlebars.registerPartial('codeceptjs/getRequestBody', Handlebars.template(codeceptjsGetRequestBody));
    Handlebars.registerPartial('codeceptjs/getResponseBody', Handlebars.template(codeceptjsGetResponseBody));
    Handlebars.registerPartial('codeceptjs/getResponseHeader', Handlebars.template(codeceptjsGetResponseHeader));
    Handlebars.registerPartial('codeceptjs/sendRequest', Handlebars.template(codeceptjsSendRequest));
    Handlebars.registerPartial('codeceptjs/request', Handlebars.template(codeceptjsRequest));

    // Specific files for the axios client implementation
    Handlebars.registerPartial('k6/getHeaders', Handlebars.template(k6GetHeaders));
    Handlebars.registerPartial('k6/getRequestBody', Handlebars.template(k6GetRequestBody));
    Handlebars.registerPartial('k6/getResponseBody', Handlebars.template(k6GetResponseBody));
    Handlebars.registerPartial('k6/getResponseHeader', Handlebars.template(k6GetResponseHeader));
    Handlebars.registerPartial('k6/sendRequest', Handlebars.template(k6SendRequest));
    Handlebars.registerPartial('k6/request', Handlebars.template(k6Request));
